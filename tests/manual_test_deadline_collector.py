...
def test_render_collector_manually():
    ...
    try:
        ...
        test_json_file = os.path.join(os.path.dirname(__file__), 'test_data', 'jobs_KIT_0070_MayaBatch.json')
        ...
        with patch('render_manager.core.dl_collector_job.deadline_collector.json_file', test_json_file):
            from render_manager.core.dl_collector_job.deadline_collector import RenderCollector
