...
class RemoveRenderLayer:
    def __init__(self, render_layer: Render):
        """Initialize the instance with a render layer.

        Args:
            render_layer (Render): The render layer object to be associated with this instance.
        """
    ...
    def get_backdrops(self) -> str or bool:
        """Returns all backdrops nodes with attribute ROLE_LAYER matching role_layer for this render layer object."""
