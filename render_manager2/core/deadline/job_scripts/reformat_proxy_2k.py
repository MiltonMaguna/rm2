...
def reformat_proxy2k(*args, **kwargs):
    log.info("Running Reformat Proxy2k Script")
    ...
    OUTPUT_FILE = INPUT_FILE.replace("/CG/", "/PROXY/")
    ...
    log.info(f"{cmd}")
    log.info("Closing Reformat Proxy2k oiio Script")
