...
if nuke.NUKE_VERSION_MAJOR >= 16:
    ...
    from PySide6.QtWidgets import QDialog, QMainWindow, QMenu, QTableView

    PYSIDE_VERSION = 6
else:
    from PySide2 import QtCore
    from PySide2.QtGui import QCursor, QIcon
    from PySide2.QtWidgets import QAction, QDialog, QMainWindow, QMenu, QTableView
...
from RenderManager2.render_manager2.mvc.config import MODEL_DATA
from RenderManager2.render_manager2.mvc.libs.edit_render_dialog import (
    EditRenderDialog,
)
from RenderManager2.render_manager2.mvc.model import RenderTableModel

log = get_stream_logger('RenderManager2 - View')
...
class RendersView:
    def __init__(self, parent, ui: QMainWindow, table_widget: QTableView):
        ...
        Args:
            parent (version parent): version parent object
            ui (version parent ui): version parent ui
            table_widget (table widget to load): table widget to load
        """
        self.parent = parent
        self.ui = ui
    ...
    def template_structure_callback(self):
        """Calls for template structure module."""
        selection = self.get_view_selection()
